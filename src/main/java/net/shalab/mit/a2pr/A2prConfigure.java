...
public final class A2prConfigure{
    ...
    final java.util.Map<java.text.AttributedCharacterIterator.Attribute,Object> headerAttributes;
    final java.util.Map<java.text.AttributedCharacterIterator.Attribute,Object> titleAttributes;
    final java.util.Map<java.text.AttributedCharacterIterator.Attribute,Object> footerAttributes;
    final java.util.Map<java.text.AttributedCharacterIterator.Attribute,Object> lineNumberAttribues;
    ...
    public A2prConfigure(){
        ...
        this.headerAttributes = new java.util.HashMap<>();
        {
        ...
        this.titleAttributes = new java.util.HashMap<>();
        {
        ...
        this.footerAttributes = new java.util.HashMap<>();
        {
        ...
        this.lineNumberAttribues = new java.util.HashMap<>();
        {
    ...
    public final java.util.Map< java.text.AttributedCharacterIterator.Attribute,Object > createLineNumberAttributes(){
    ...
    public final synchronized boolean isPrintLineNumber(){
        return (line_numbers < 1) ? false : true;
    }
  
    public final synchronized PrintRequestAttributeSet createxPrintRequestAttributeSet(){
    ...
    public final synchronized boolean isPrintUserName(){
